...
public class Encrypter implements SecretKey {
	/**
	 * the alphabet has 26 letters, all upper case and the 27th corresponds to
	 * everything else (including blanks)
	 */
	...
	/**
	 * Encrypts a message using a (secret) key with the Vigenere Code. The
	 * message is first translated into upper case letters.
	 *
	 * @param plainText
	 *            has the plain text
	...
	/**
	 * Decrypts a message using a (secret) key with the Vigenere Code. It only
	 * deciphers into upper case letters.
	 * 
	 * @param cypherText
	 *            the encrypted text
	...
	public static String decrypt(String cypherText) {
		...
		for (int i = 0; i < plain.length; i++) {
			plain[i] = letter((code(plain[i]) + NUM_LETTERS - code(KEY[i % m])) % NUM_LETTERS);
		}
	 ...
	 * a letter, the lower case letter is translated to upper case and then the
	 * codes are returned as 'A' is given code 0 'B' is given code 1 ... 'Z' is
	 * given code25 and everything else (including blanks) is given code
	 * NUM_LETTERS-1
	 *
	 * @param ch
	 *            character whose code we return
	...
	/**
	 * Returns the letter of the code passed. The inverse method of code Given
	 * the code 0, is given the letter 'A' the code 1, is given the letter 'B'
	 * ... the code 25, is given the letter 'Z' the code NUM_LETTERS-1 is given
	 * ' '
	 * 
	 * @param x
	 *            is in [0 .. NUM_LETTER-1], this is a precondition
	...
	/**
	 * Get the inverted key. You can decipher by using the inverted key and the
	 * ciphered text but still use the encrypt function invertKey is like
	 * negating the key
	 *
	 * @param key
	 *            has characters assigned up to key.length
	 */
