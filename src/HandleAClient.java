 ...
 * process the commands sent by the client to encrypt and decrypt.
 * It starts the process by sending a NAME to the client.
 * 
...
public class HandleAClient implements Runnable, Encryptable 
{
   ...
   */
   ...
   /**
   * Reads the number of characters that are going to be read in the plain text
   * coming from the client.
   * Does the actual encryption.
   * Sends the encrypted text to the client with the "DATA" message (command)
   */
